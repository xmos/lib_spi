...
.. note::
    ...
    See the SPI slave example in ``examples/app_spi_slave`` for more details on different ways of working with the SPI slave component.
...
.. note::
      ...
      console (either using JTAG or xSCOPE to
