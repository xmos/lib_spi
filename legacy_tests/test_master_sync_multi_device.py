...
def do_multi_device_sync(full_load, miso_enabled, mosi_enable, div, mode):
    ...
    binary = "spi_master_sync_multi_device/bin/{load}_{miso}_{mosi}_{div}_{mode}/spi_master_sync_multi_device_{load}_{miso}_{mosi}_{div}_{mode}.xe".format(load=full_load,miso=miso_enabled,mosi=mosi_enable,div=div,mode=mode)
