...
def do_slave_rx_tx(full_load, miso_enable, mosi_enable, mode, in_place):
    ...
    binary = "spi_slave_rx_tx/bin/{load}_{miso}_{mosi}_{m}_{in_place}/spi_slave_rx_tx_{load}_{miso}_{mosi}_{m}_{in_place}.xe".format(load=full_load,miso=miso_enable,mosi=mosi_enable,m=mode,in_place=in_place)
