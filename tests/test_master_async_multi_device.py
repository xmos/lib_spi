...
appname = "spi_master_async_multi_device"
...
def do_test(capfd, combined, burnt, mosi_enabled, arch, id):
    ...
    Pyxsim.run_on_simulator_(
        binary,
        # simargs=['--vcd-tracing', '-o ./trace.vcd -tile tile[0] -pads -functions'],
...
def test_master_async_multi_device(capfd, params, request):
