...
typedef enum spi_mode_t {
  SPI_MODE_0 = 0, /**< SPI Mode 0 - Polarity = 0, Clock Edge = 0 */
  SPI_MODE_1 = 1, /**< SPI Mode 1 - Polarity = 0, Clock Edge = 1 */
  SPI_MODE_2 = 2, /**< SPI Mode 2 - Polarity = 1, Clock Edge = 0 */
  SPI_MODE_3 = 3, /**< SPI Mode 3 - Polarity = 1, Clock Edge = 1 */
} spi_mode_t;
